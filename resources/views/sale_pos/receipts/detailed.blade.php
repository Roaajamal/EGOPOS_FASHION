    ...
    <tbody>
        ...
        <tr>
            <td>
                ...
                {{-- JoFotara QR Code (Jordan E-Invoicing System) --}}
                @if(!empty($receipt_details->fatora_qr_code))
                @php
                    // Clean and validate QR code
                    $qr_code = trim($receipt_details->fatora_qr_code);
                ...
                <div class="row" style="color: #000000 !important; margin-top: 15px;">
                    <div class="col-xs-12 text-center">
                        ...
                        <h4 style="margin: 5px 0; font-weight: bold;">رمز الاستجابة السريعة - نظام الفوترة الأردني</h4>
                        <p style="margin: 3px 0; font-size: 11px;">
                            @if(!empty($receipt_details->fatora_invoice_number))
                                <strong>رقم الفاتورة:</strong> {{ $receipt_details->fatora_invoice_number }}
                            @endif
                        </p>
                        
                        {{-- QR Code Image --}}
                        <div style="margin: 10px auto; padding: 10px; background: #fff; display: inline-block; border: 2px solid #000;">
                        ...
                        <p style="margin: 5px 0; font-size: 10px;">امسح الرمز للتحقق من صحة الفاتورة</p>
                        
                        @if(!empty($receipt_details->fatora_invoice_uuid))
                            <p style="margin: 3px 0; font-size: 9px; color: #666;">
                                UUID: {{ substr($receipt_details->fatora_invoice_uuid, 0, 20) }}...
                            </p>
                        @endif
                    </div>
                </div>
