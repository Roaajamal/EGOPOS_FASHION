...
@endif
@endif
{{-- إضافة شرط تفعيل الفوترة من الإعدادات إلى جانب شرط الـ only --}}
@if((empty($only) || in_array('fatora_status', $only)) && !empty($pos_settings['enable_fatora']))
<div class="col-md-3">
    <div class="form-group">
        {!! Form::label('fatora_status', __('lang_v1.fatora_status') . ':') !!}
        {!! Form::select('fatora_status', 
            [
                '' => __('lang_v1.all'),
                'sent' => __('lang_v1.sent'),
                'not_sent' => __('lang_v1.not_sent'),
            ], 
            null, 
            [
                'class' => 'form-control select2',
                'style' => 'width:100%',
                'id' => 'fatora_status_filter'
            ]
        ) !!}
    </div>
</div>
