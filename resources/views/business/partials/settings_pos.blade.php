<div class="pos-tab-content">
    ...
    <div class="form-group">
        ...
        <div class="checkbox">
          <label>
            {!! Form::checkbox('pos_settings[show_product_details_on_close_register]', 1, !empty($pos_settings['show_product_details_on_close_register']), ['class' => 'input-icheck']); !!} {{ __( 'cash_register.show_product_details_on_close_register' ) }}
          </label>
        </div>
    </div>
</div>
