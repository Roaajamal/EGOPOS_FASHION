@extends('layouts.app')
@section('title', __('stock_adjustment.stock_out_quantity'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">@lang('stock_adjustment.stock_out_quantity')
        <small></small>
    </h1>
</section>
...
<section class="content">
    @component('components.widget', ['class' => 'box-primary', 'title' => __('stock_adjustment.all_stock_out')])
        @slot('tool')
            <div class="box-tools">
