...
<section class="content no-print">
	...
	<div class="box box-solid">
		...
		<div class="box-body">
			...
			{{-- تنبيه نظام الفوترة الأردني --}}
			@php
				$originalFatoraInvoice = is_invoice_sent_to_fatora($sell->id);
			@endphp
			...
			<div class="row" style="margin-top: 15px;">
				<div class="col-sm-12">
					<div class="alert alert-warning" style="margin-bottom: 0;">
						...
						هذه الفاتورة مُرسلة لنظام الفوترة الأردني 
						<span class="badge bg-green">
							<i class="fa fa-check-circle"></i> JoFotara
						</span>
						<br>
						<small>
							<i class="fa fa-info-circle"></i>
							<strong>يجب</strong> إرسال المرتجعات أيضاً لنظام الفوترة بعد حفظها.
							رقم الفاتورة الأصلية في النظام: <strong>{{ $originalFatoraInvoice->system_invoice_number ?? 'N/A' }}</strong>
						</small>
					</div>
				</div>
			</div>
