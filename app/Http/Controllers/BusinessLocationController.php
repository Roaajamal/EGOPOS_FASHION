    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $input = $request->only(['name', 'landmark', 'city', 'state', 'country', 'zip_code', 'invoice_scheme_id',
                ...
                'location_id', 'selling_price_group_id', 'default_payment_accounts', 'featured_products', 
                'sale_invoice_layout_id', 'sale_invoice_scheme_id', 'max_users']);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $input = $request->only(['name', 'landmark', 'city', 'state', 'country',
                ...
                'invoice_layout_id', 'mobile', 'alternate_number', 'email', 'website', 'custom_field1', 'custom_field2', 'custom_field3', 'custom_field4', 
                'location_id', 'selling_price_group_id', 'default_payment_accounts', 'featured_products', 'sale_invoice_layout_id',
                 'sale_invoice_scheme_id', 'max_users' ]);
