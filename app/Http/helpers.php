...
/**
 * Check if transaction/invoice was sent to JoFotara (Jordan E-Invoicing System)
 * Returns invoice data if sent, null if not
 */
if (!function_exists('is_invoice_sent_to_fatora')) {
    function is_invoice_sent_to_fatora($transaction_id)
    {
...
/**
 * Check if invoice can be edited (not sent to Fatora)
 */
if (!function_exists('can_edit_fatora_invoice')) {
    function can_edit_fatora_invoice($transaction_id)
    {
        $fatoraInvoice = is_invoice_sent_to_fatora($transaction_id);
