...
class SettingsController extends Controller
{
    ...
    public function index()
    {
        ...
        $accounts = AccountingAccount::forDropdown($business_id);
        ...
        return view('accounting::settings.index')->with(compact('accounts','account_sub_types', 'account_types', 'accounting_settings', 'business_locations', 'expence_categories'));
    }
