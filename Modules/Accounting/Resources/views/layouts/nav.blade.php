        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    @endif
                    <li @if(request()->segment(2) == 'vouchers') class="active" @endif>
    <a href="{{ action([\Modules\Accounting\Http\Controllers\VoucherController::class, 'index']) }}">
        <span class="title"> @lang('accounting::lang.vouchers') </span>
    </a>
</li>



    <li @if(request()->segment(2) == 'cheques') class="active" @endif>
    <a href="{{ action([\Modules\Accounting\Http\Controllers\ChequeController::class, 'index']) }}">
