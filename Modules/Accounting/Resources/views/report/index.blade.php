...
<section class="content">
    <div class="row">
        {{-- تقرير قائمة الدخل - وضعناه في البداية لأهميته وبنفس تنسيق البقية --}}
        <div class="col-md-6">
            <div class="box box-warning">
                <div class="box-header with-border">
                    <h3 class="box-title">قائمة الدخل (الأرباح والخسائر)</h3>
                </div>
                <div class="box-body">
                    عرض ملخص شامل للإيرادات والمصروفات لتحديد صافي الربح أو الخسارة خلال فترة زمنية محددة.
                    <br/>
        ...
        <div class="col-md-6">
            <div class="box box-warning">
                ...
                <div class="box-body">
                    ...
                    <br/>
                    <a href="{{route('accounting.account_receivable_ageing_report')}}" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm pt-2">@lang( 'accounting::lang.view_report')</a>
                </div>
            </div>
        </div>

        {{-- تقارير أعمار الذمم الدائنة --}}
        <div class="col-md-6">
            <div class="box box-warning">
                <div class="box-header with-border">
                ...
                <div class="box-body">
                    ...
                    <br/>
                    <a href="{{route('accounting.account_payable_ageing_report')}}" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm pt-2">@lang( 'accounting::lang.view_report')</a>
                </div>
            </div>
        </div>

        {{-- تفاصيل أعمار الذمم المدينة --}}
        <div class="col-md-6">
            <div class="box box-warning">
                <div class="box-header with-border">
                ...
                <div class="box-body">
                    ...
                    <br/>
                    <a href="{{route('accounting.account_receivable_ageing_details')}}" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm pt-2">@lang( 'accounting::lang.view_report')</a>
                </div>
            </div>
        </div>

        {{-- تفاصيل أعمار الذمم الدائنة --}}
        <div class="col-md-6">
            <div class="box box-warning">
                <div class="box-header with-border">
                ...
                <div class="box-body">
                    ...
                    <br/>
                    <a href="{{route('accounting.account_payable_ageing_details')}}" class="tw-dw-btn tw-dw-btn-primary tw-text-white tw-dw-btn-sm pt-2">@lang( 'accounting::lang.view_report')</a>
                </div>
            </div>
        </div>
    </div>
