        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="form-group">
                    ...
                    {!! Form::select('location_id', $business_locations, $journal->location_id, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(document).on('change', '.credit, .debit', function(){
            if($(this).hasClass('credit') && $(this).val() > 0){
                $(this).parents('tr').find('.debit').val('');
            } else if($(this).hasClass('debit') && $(this).val() > 0){
        ...
        $('#addRow').click(function() { 
            ...
            var newRow = `
                <tr>
                    <td>${rowCount}</td>
                    <td>
                        <select name="account_id[${rowCount}]" class="form-control accounts-dropdown account_id" style="width: 100%;" placeholder="@lang('messages.please_select')"></select>
                    </td>
            ...
            initializeSelect2($('#tableBody tr:last-child .accounts-dropdown'));
        });
