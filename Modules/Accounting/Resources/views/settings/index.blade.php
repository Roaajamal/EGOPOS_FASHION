			...
			<div class="nav-tabs-custom">
				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="account_setting">
						...
						<hr>
<strong>إدخال الكميات (Add Quantity)</strong>
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('add_qty_deposit_to', 'حساب المخزون (المدين):' ) !!}
            {!! Form::select('add_qty_deposit_to', !is_null($accounts) ? $accounts : [], $default_map['add_quantity']['deposit_to'] ?? null, [
                'class' => 'form-control accounts-dropdown width-100',
                'placeholder' => __('accounting::lang.deposit_to'), 
                'name' => "accounting_default_map[$business_location->id][add_quantity][deposit_to]",
                'id' => $business_location->id . '_add_qty_deposit_to'
            ]); !!}
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('add_qty_payment_account', 'حساب تسوية المخزون (الدائن):' ) !!}
            {!! Form::select('add_qty_payment_account', !is_null($accounts) ? $accounts : [], $default_map['add_quantity']['payment_account'] ?? null, [
                'class' => 'form-control accounts-dropdown width-100',
                'placeholder' => __('accounting::lang.payment_account'), 
                'name' => "accounting_default_map[$business_location->id][add_quantity][payment_account]",
                'id' => $business_location->id . '_add_qty_payment_account'
            ]); !!}
        </div>
    </div>
</div>
...
<strong>المخزون الافتتاحي (Opening Stock)</strong>
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('os_deposit_to', 'حساب المخزون (المدين):' ) !!}
            {!! Form::select('os_deposit_to', !is_null($accounts) ? $accounts : [], $default_map['opening_stock']['deposit_to'] ?? null, [
                'class' => 'form-control accounts-dropdown width-100',
                'placeholder' => __('accounting::lang.deposit_to'), 
                'name' => "accounting_default_map[$business_location->id][opening_stock][deposit_to]",
                'id' => $business_location->id . '_os_deposit_to'
            ]); !!}
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('os_payment_account', 'حساب رأس المال/الافتتاحي (الدائن):' ) !!}
            {!! Form::select('os_payment_account', !is_null($accounts) ? $accounts : [], $default_map['opening_stock']['payment_account'] ?? null, [
                'class' => 'form-control accounts-dropdown width-100',
                'placeholder' => __('accounting::lang.payment_account'), 
                'name' => "accounting_default_map[$business_location->id][opening_stock][payment_account]",
                'id' => $business_location->id . '_os_payment_account'
            ]); !!}
        </div>
    </div>
</div>
